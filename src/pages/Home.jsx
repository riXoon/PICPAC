  ...
  return (
    <section className='bg-zinc-50 mt-4 min-h-screen shadow-md flex flex-row justify-center items-center rounded-md'>
      ...
      <div className='flex flex-col items-center justify-center gap-10'>
        ...
        <button onClick={startBooth} className='text-xl uppercase text-indigo-500 font-bold tracking-wide border-4 border-indigo-500 px-20 py-4 rounded-xl flex items-center gap-4 cursor-pointer transition-transform duration-300 transform hover:scale-105 hover:bg-indigo-50 active:scale-95'>
          Start Booth 
          <CiCamera 
          size={30} 
